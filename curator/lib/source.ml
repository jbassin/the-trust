...
let normalize = function
  ...
  | "Pathfinder #153: Life's Long Shadow" | "Pathfinder #153: Life's Long Shadows" -> find ~abbr:"AP:153"
  ...
  | "Pathfinder #178: Punks in a Powder Keg" -> find ~abbr:"AP:178"
  ...
  | "Pathfinder Beginner Box: Hero's Handbook" | "Pathfinder Beginners Box" -> find ~abbr:"BB"
  | "Pathfinder Bestiary 2" -> find ~abbr:"B:2"
  | "Pathfinder Bestiary 3" -> find ~abbr:"B:3"
  | "Pathfinder Bestiary" -> find ~abbr:"B:1"
  | "Pathfinder Blog" | "Pathfinder Blog: April Fools" | "Pathfinder Blog: The Waters of Stone Ring Pond" ->
    find ~abbr:"BLOG"
  ...
  | "Pathfinder Lost Omens Ancestry Guide" | "Pathfinder Lost Omens: Ancestry Guide" -> find ~abbr:"LO:AG"
  | "Pathfinder Lost Omens Legends" | "Pathfinder Lost Omens: Legends" -> find ~abbr:"LO:L"
  | "Pathfinder Lost Omens World Guide" | "Pathfinder Lost Omens: World Guide" -> find ~abbr:"LO:WG"
  | "Pathfinder Lost Omens: Absalom, City of Lost Omens" -> find ~abbr:"LO:A"
  | "Pathfinder Lost Omens: Character Guide" | "Pathfinder Lot Omens Character Guide" -> find ~abbr:"LO:CG"
  | "Pathfinder Lost Omens: Gods & Magic" | "Pathfindier Core Rulebook, Pathfinder Lost Omens: Gods & Magic" ->
    find ~abbr:"LO:G&M"
  ...
  | "Pathfinder Society Scenario #1-08: Revolution on the Riverside" -> find ~abbr:"SS:108"
  | "Pathfinder Society Scenario #1-15: The Blooming Catastrophe" -> find ~abbr:"SS:115"
  | "Pathfinder Society Scenario #1-17: The Perennial Crown Part 2, The Thorned Monarch" -> find ~abbr:"SS:117"
  | "Pathfinder Society Scenario #1-19: Iolite Squad Alpha" -> find ~abbr:"SS:119"
  | "Pathfinder Society Scenario #1-24: Lightning Strikes, Stars Fall" -> find ~abbr:"SS:124"
  | "Pathfinder Society Scenario #2-09: The Seven Secrets of Dacilane Academy" -> find ~abbr:"SS:209"
  ...
  | "Pathfinder Society Scenario 2-24: Breaking The Storm: Parting Clouds" -> find ~abbr:"SS:224"
  ...
  | "" -> None
  | source ->
    err [%message "unexpected source" source];
    None
;;
